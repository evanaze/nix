let
  module =
    # aspects/business/nocodb.nix - NocoDB (via Docker, as recommended upstream)
    {
      lib,
      pkgs,
      ...
    ...
    in {
      ...
      services.tailscale.serve.services.nocodb.endpoints."tcp:443" = "https://127.0.0.1:${toString caddyPort}";
    };
in {
  flake.modules.nixos = {
